...
myartistGB = gbvideos.loc[gbvideos['channel_title'].str.contains("John Lewis", case=False)]

myartistCA = cavideos.loc[cavideos['channel_title'].str.contains("John Lewis", case=False)]
